  ...
  <div class="container-fluid containernav" style="margin: 0px 45px;">
    <a class="navbar-brand" href="#">
      <div class="row justify-content-center align-items-center">
        <img src="<?= BASE_URL ?>/assets/images/logo.png" class="h-8 logomenu" alt="Logo">
      </div>
    </a>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      <div class="offcanvas-header">
        <img src="<?= BASE_URL ?>/assets/images/logo.png" class="offcanvas-title" style="width: 80%;" alt="Logo fastpack">
